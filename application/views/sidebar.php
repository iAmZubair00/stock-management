    ...
    <li class="nav-item">
        ...
        <div id="collapseSubject" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo base_url() . 'product' ?>">View Subject</a>
                <div class="collapse-divider"></div>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSubject" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo base_url() . 'Subject/addSubjectScreen' ?>">Add Order</a>
                <a class="collapse-item" href="<?php echo base_url() . 'order' ?>">View Order</a>
                <div class="collapse-divider"></div>
            </div>
        </div>
    </li>
